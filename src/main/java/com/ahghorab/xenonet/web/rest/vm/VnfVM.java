...
public class VnfVM extends BaseEntityVM<Integer>{
    ...
    public VnfVM(String source, String key, String name, String describtion, String loc, String ipAddress, String cpu, String ram, String isDedicatedRes, List<String> leftArray, List<String> topArray, List<String> bottomArray, List<String> rightArray, List<DiagramEntityConnectionsVM> diagramEntityConnections) {
        this.source = source;
        this.key = key;
        this.name = name;
